...
const Footer = () => {
  return (
    <>
        ...
        <p className="socials"> 
          <a href="https://github.com/Rishabhpathak22" rel="noreferrer" target="_blank"><VscGithub size={25}/></a>
          <a href="https://www.linkedin.com/in/rishabh-pathak-indore-it22/" rel="noreferrer" target="_blank"><SiLinkedin size={25}/></a>
        </p>
        <p>
            <a href="https://github.com/Rishabhpathak22/todoapp.git" rel="noreferrer" target="_blank" className="source">$Source | 2023 - 2024</a> 
        </p> 
